...
using S = pair<pair<ll, ll>, pair<ll, ll>>;
S op(S a, S b) {
    if(a.first.first < b.first.first) swap(a, b);
    S res;
    if(a.first.first == b.first.first) res.first = {a.first.first, a.first.second+b.first.second};
    else res.first = a.first;
    
    if(res.first.first == b.first.first){
        if(a.second.first > b.second.first) res.second = a.second;
        else if(a.second.first == b.second.first) res.second = {a.second.first, a.second.second+b.second.second};
        else res.second = b.second;
    }else{
        if(a.second.first > b.first.first) res.second = a.second;
        else if(a.second.first == b.first.first) res.second = {a.second.first, a.second.second+b.first.second};
        else res.second = b.first;
    }
    return res;
}
