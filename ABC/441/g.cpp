...
F composition(F b, F a) { 
    if(b.first > 0) return {a.first+b.first, b.second};
...
int main(){
    int n, q; cin >> n >> q;
    LazySegmentTree<S, op, e, F, mapping, composition, id> lst(vector<S>(n, {0, 1, 0}));
    while(q--){
        int t; cin >> t;
        if(t == 1){
